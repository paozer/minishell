...
**
** if handles redirect chararacter and filename in diff tokens
** else handles redirect chararacter and filename in same token
*/
...
**
** if handles pipe character and program name in diff tokens
** else handles pipe character and program name in same token
*/
